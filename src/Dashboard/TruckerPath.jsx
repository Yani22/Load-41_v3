...
export const TruckerPath = () => {
  ...
  const Update = async () => {
    ...
    await axios.post(`http://localhost:5000/trucker_update_load`, data, {
      headers: {
  ...
  const bulkDeleteLoad = async () => {
    ...
    await axios.post(`http://localhost:5000/trucker_delete_load`, data, {
      headers: {
        'Authorization': `Bearer ${localStorage.getItem('trucker_token')}`
      }
    })
  ...
  const Submit = async () => {
    ...
    try {
      const docRef = await axios.post('http://localhost:5000/trucker_submit_load', data, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('trucker_token')}`      
          }
      })
